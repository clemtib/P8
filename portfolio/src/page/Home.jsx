...
export default function Home() {
   ...
   //       const dotSize = Math.floor(Math.random() * 31) + 5; // Génère une taille aléatoire entre 10 et 30 (10 + 21)
   ...
   //       // Disparition progressive du rond
   //       setTimeout(() => {
   //          dot.style.opacity = "0";
   //          dot.addEventListener("transitionend", () => {
   //             dot.remove();
   //          });
   //       }, 5000); // Supprime le rond après 5 secondes
   //    };
